...
__GLOBAL_INI_TBL:
	...
	.DW  0x01
	.DW  _matrix_status_new_S0040001000
	.DW  _0x8000E*2

	.DW  0x01
	.DW  _matrix_status_S0040001000
	.DW  _0x8000F*2
...
; 0004 004D 	matrix_status_new = Transmission_Get_EN();
	...
	STS  _matrix_status_new_S0040001000,R30
; 0004 004E 
; 0004 004F 	if(matrix_status != matrix_status_new)
	LDS  R26,_matrix_status_S0040001000
	CP   R30,R26
	BREQ _0x80010
; 0004 0050 	{
; 0004 0051 		count_delay++;
	LDS  R30,_count_delay_S0040001000
	SUBI R30,-LOW(1)
	STS  _count_delay_S0040001000,R30
; 0004 0052 	}
; 0004 0053 
; 0004 0054 	if(count_delay == 6)
_0x80010:
	LDS  R26,_count_delay_S0040001000
	CPI  R26,LOW(0x6)
	BRNE _0x80011
; 0004 0055 	{
; 0004 0056 		switch(matrix_status_new)
	LDS  R30,_matrix_status_new_S0040001000
	LDI  R31,0
; 0004 0057 		{
; 0004 0058 			case R:
	SBIW R30,0
...
; 0004 008C 		matrix_status = matrix_status_new;
	LDS  R30,_matrix_status_new_S0040001000
	STS  _matrix_status_S0040001000,R30
; 0004 008D 	}
; 0004 008E }
_0x80011:
	RET
